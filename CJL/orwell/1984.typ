...
#work(
  ...
  characteristics: (
    ...
    name-meaning: [
      - Název „1984“ odkazuje na rok, ve kterém se odehrává děj románu (údajně -- není nikdy potvrzeno, možná manipulace ministerstvem pravdy??), a symbolizuje dystopickou budoucnost, kde je společnost ovládána totalitním režimem.
      - Název také může být interpretován jako varování před velice brzkým nebezpečím totalitarismu a ztráty individuální svobody -- v roce 1949 nebyl rok 1984 tak vzdálený.
    ],
    tema: [
      - Příběh o životě Winstona Smithe v dystopickém, totalitním režimu
      - Téma totalitarismu, manipulace, cenzura, sledování, ztráty individuality a svobody
      - Kritika totalitních režimů, zejména sovětského komunismu (shoduje se s Farmou zvířat -- Orwell byl spíše levičák a kritizoval deformace socialismu)
    ],
  ),
  literary-context: (
    umelecke-smer: [
      ...
      Román 1984 je typickým dílem antiutopické literatury, která zobrazuje negativní podobu budoucí společnosti jako varování. Orwell navazuje na modernistickou tradici kritického pohledu na civilizaci, moc a jazyk, ale používá srozumitelný, věcný styl, nikoli experimentální jazyk.
    ],
    ...
    soucasnici: [
      ...
      - *Ray Bradbury* -- Marťanská kronika, 451° Fahrenheita
      - *J. R. R. Tolkien* -- Pán Prstenů
      - *Jevgenij Ivanovič Zamjatin* (1884 -- 1937) -- *My*, Rus, spisovatel antiutopií. kritizoval komunismus
      - Tematicky podobné dílo -- *Aldous Huxley* -- Ostrov
    ],
    dalsi-dila: [
      - *Farma zvířat* -- alegorický román kritizující totalitní režimy
  ...
  kompozice: [
    ...
    - Chronologická kompozice, retrospektivní části (vzpomínky na dětství, poslední setkání s Julií)
  ],
  obsah-dila: [
    Dílo se odehrává v Londýně v údajném roce 1984 (Oceánie).
    ...
    *V první části autor charakterizuje totalitní režim, v druhé části se pak Winston setkává s Julií a ve třetí části je Winston na Ministerstvu lásky a je mučen*
    ...
    - *Newspeak* -- uměle vytvořený jazyk, jehož cílem je omezit rozsah myšlení a vyjádření
    - *Ideozločin* -- jakýkoli čin nebo myšlenka, která je v rozporu s učením Strany
    - *Udržovací válka* -- věčný konflikt mezi třemi velmocemi, který má udržet společnost v chudobě a poslušnosti

    *Porovnání s 451° Fahrenheita*
    - 1984
        - Společnost je řízena otevřeným terorem.
        - Neustálý dohled (teleobrazovky).
        - Stát přepisuje minulost a definuje pravdu.
        - Jazyk (novomluva) je systematicky zužován, aby znemožnil kritické myšlení.
    - 451 stupňů Fahrenheita
      - Lidé nejsou násilím nuceni myslet povrchně $arrow.r$ sami to chtějí.
      - Knihy jsou páleny, aby lidé nebyli zneklidňováni rozdílnými názory.
      - Masmédia, obrazovky a zábava nahrazují skutečné myšlení.
      - Cenzura je výsledkem společenské poptávky, ne jen státní moci.
  ],
  postavy: [
    - *Winston Smith* -- hlavní hrdina, nesouhlasí s ideologií, přemýšlí, co předcházelo diktatuře, pracuje na Ministerstvu pravdy, které se zabývá falšováním historie, sám historii falšuje, ale snaží se uchovat si pravdu ve vlastních myšlenkách, snaží se o odboj, zamiluje se do Julie, ale pak je chycen Ideopolicií a psychicky i fyzicky týrán, což vede k naprostému obratu $arrow.r$ začne milovat Velkého Bratra a zradí Julii.
    - *Julie* -- na první pohled věrná členka strany, Winstonova přítelkyně
    - *O'Brien* -- navenek nepřítelem strany, ve skutečnosti fanaticky věří, odhalí Winstonův a Juliin ideozločin
    - *Goldstein* -- nepřítel a zrádce strany, může být pouze neexistující symbol - stejně jako Velký Bratr
    - *Velký Bratr* -- vůdce strany, domnělý otec revoluce, má vždy pravdu a nemění svá rozhodnutí
    
    *Vedlejší postavy:*
    - *Parsons* (a jeho rodina) -- Winstonův soused, hloupý, páchne potem, naprosto oddaný Straně, ale je také vaporizován $arrow.r$ udá ho vlastní dcera, když ze spánku křičí Pryč s Velkým Bratrem
    - *Charrington* -- majitel obchodu s veteší, pronajímá Winstonovi pokoj, ale je členem Ideopolicie, právě díky němu jsou lapeni

  ],
  vypravecsky-zpusob: [
    - Třetí osoba, vševědoucí vypravěč
    - Vnitřní monology (Winstonovy myšlenky)
    - Dialogy mezi postavami
    - Vyprávěcí způsob: vyprávěcí, popisný, místy úvahový
    - Popisy prostředí a atmosféry
    - Symbolismus (Velký Bratr, telescreeny, Newspeak)
  ],
  jazyk-dila: [
    - Jazyk spisovný, výjimečně hovorové prvky
    - Monolog, dialog, přímá řeč, polopřímá řeč, charakteristika, úryvky textů, slogany
    - Užití již zmíněného Newspeaku
    - Metafora (pouze uši měl bílou jako sníh)
    - Temná, pesimistická, frustrovaná atmosféra

  ],
  ohlas-dila: [
    - U nás do listopadu 1989 zakázán, v západních zemích obrovský úspěch.
    - Obrovskou inspirací pro autory sci-fi.
  ],
  ctenar: [
    Absolutní klasika
  ],
